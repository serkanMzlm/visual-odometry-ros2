...
class VisualOdometry(Node):
    def __init__(self, data_dir):
        ...
        # config_file = os.path.join(get_package_share_directory('visual_odometry'))
        # print(config_file)
        self.K, self.P = self._load_calib(os.path.join(data_dir, '/home/serkan/source_code/visual-odometry-ros2/src/visual_odometry/visual_odometry/KITTI_sequence_1/calib.txt'))
        self.gt_poses = self._load_poses(os.path.join(data_dir, '/home/serkan/source_code/visual-odometry-ros2/src/visual_odometry/visual_odometry/KITTI_sequence_1/poses.txt'))
        self.images = self._load_images(os.path.join(data_dir, '/home/serkan/source_code/visual-odometry-ros2/src/visual_odometry/visual_odometry/KITTI_sequence_1/image_l'))
